...
void CGraphVizualizer::Draw(const std::string &graph)
{
...
void CGraphVizualizer::Draw(const std::string &first, const std::string &second)
{
	sf::VideoMode mode = sf::VideoMode((unsigned)WINDOW_SIZE.x, (unsigned)WINDOW_SIZE.y);
	sf::RenderWindow window(mode, "", sf::Style::Titlebar | sf::Style::Close);
...
sf::RectangleShape CGraphVizualizer::GetShape(
